...
export default function Inbox() {
  ...
  const complete = async (item: Event) => { try { await eventsApi.complete(item.id); await load(); message.success("事件已完成"); } catch (cause) { setError(userFacingError(cause)); } };
