...
export default function Inbox() {
  ...
  const visibleEvents = useMemo(() => { const status: Record<InboxTab, number> = { pending: 0, projects: 1, delegated: 2, delayed: 3, abandoned: 4, completed: 5 }; return events.filter((event) => event.status === status[filter]); }, [events, filter]);
